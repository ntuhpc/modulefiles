...
local root = "/opt/apps/software/Boost/1.63.0-foss-2016b-Python-2.7.12"
...
setenv("EBDEVELBOOST", pathJoin(root, "easybuild/Boost-1.63.0-foss-2016b-Python-2.7.12-easybuild-devel"))

setenv("BOOST_ROOT", "/opt/apps/software/Boost/1.63.0-foss-2016b-Python-2.7.12")
