...
local root = "/opt/apps/software/flex/2.6.0-GCCcore-5.4.0"
...
if not isloaded("M4/1.4.17-GCCcore-5.4.0") then
    load("M4/1.4.17-GCCcore-5.4.0")
end
...
setenv("EBDEVELFLEX", pathJoin(root, "easybuild/flex-2.6.0-GCCcore-5.4.0-easybuild-devel"))
