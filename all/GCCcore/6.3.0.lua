...
local root = "/opt/apps/software/GCCcore/6.3.0"
...
prepend_path("LD_LIBRARY_PATH", pathJoin(root, "lib/gcc/x86_64-pc-linux-gnu/6.3.0"))
...
setenv("EBDEVELGCCCORE", pathJoin(root, "easybuild/GCCcore-6.3.0-easybuild-devel"))
